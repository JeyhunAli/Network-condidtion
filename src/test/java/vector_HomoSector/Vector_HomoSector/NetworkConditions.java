...
/**
 * this something really interesting to check speed of the Internet on your  application easy to apply 
 * and to use it on your current project to see in what speed interval your application performance 
 * usually its done by manually but for i know its can be done by automatically in Chrome browser I'm pretty sure its available for ather 
 * browsers as well such as opera firefox safari and so on 
 */
...
package vector_HomoSector.Vector_HomoSector;
